 ...
 */
export type SubscriptionTier = 'FREE' | 'STANDARD' | 'CREATOR' | 'PRO' | 'FOUNDERS_EDITION' | 'TEAM' | 'ENTERPRISE';
...
export type BillingOpStatusResponse = {
     ...
     *
     */
    authentication_state?: 'requires_action' | 'processing' | 'failed_retryable' | 'succeeded' | 'reconciliation_needed';
    /**
     ...
     *
     */
    decline_reason?: 'card_declined' | 'insufficient_funds' | 'expired_card' | 'incorrect_cvc' | 'authentication_required' | 'authentication_failed' | 'processing_error' | 'generic';
    /**
     ...
     */
    recovery_action?: 'retry' | 'replace_payment_method' | 'authenticate_payment' | 'contact_support';
    /**
...
export type AgentPublishSkillError = AgentPublishSkillErrors[keyof AgentPublishSkillErrors];
...
export type AgentPublishSkillResponse = AgentPublishSkillResponses[keyof AgentPublishSkillResponses];
...
export type GetBillingCapabilitiesError = GetBillingCapabilitiesErrors[keyof GetBillingCapabilitiesErrors];
...
export type GetBillingCapabilitiesResponse = GetBillingCapabilitiesResponses[keyof GetBillingCapabilitiesResponses];
...
export type GetChurnkeyAuthError = GetChurnkeyAuthErrors[keyof GetChurnkeyAuthErrors];
...
export type GetChurnkeyAuthResponse = GetChurnkeyAuthResponses[keyof GetChurnkeyAuthResponses];
...
export type GetBillingCompanyDetailsError = GetBillingCompanyDetailsErrors[keyof GetBillingCompanyDetailsErrors];
...
export type GetBillingCompanyDetailsResponse = GetBillingCompanyDetailsResponses[keyof GetBillingCompanyDetailsResponses];
...
export type UpdateBillingCompanyDetailsError = UpdateBillingCompanyDetailsErrors[keyof UpdateBillingCompanyDetailsErrors];
...
export type UpdateBillingCompanyDetailsResponse = UpdateBillingCompanyDetailsResponses[keyof UpdateBillingCompanyDetailsResponses];
...
export type ListSavedPaymentMethodsError = ListSavedPaymentMethodsErrors[keyof ListSavedPaymentMethodsErrors];
...
export type ListSavedPaymentMethodsResponse = ListSavedPaymentMethodsResponses[keyof ListSavedPaymentMethodsResponses];
...
export type GetJobAssetsResponse = GetJobAssetsResponses[keyof GetJobAssetsResponses];
...
export type GetProviderPolicyError = GetProviderPolicyErrors[keyof GetProviderPolicyErrors];
...
export type GetProviderPolicyResponse = GetProviderPolicyResponses[keyof GetProviderPolicyResponses];
...
export type PutProviderPolicyError = PutProviderPolicyErrors[keyof PutProviderPolicyErrors];
...
export type PutProviderPolicyResponse = PutProviderPolicyResponses[keyof PutProviderPolicyResponses];
...
export type RedirectExtensionScriptsError = RedirectExtensionScriptsErrors[keyof RedirectExtensionScriptsErrors];
