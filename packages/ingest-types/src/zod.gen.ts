...
export const zSubscriptionDiscount = z.object({
    amount_off_cents: z.coerce.bigint().min(BigInt('-9223372036854775808'), { message: 'Invalid value: Expected int64 to be >= -9223372036854775808' }).max(BigInt('9223372036854775807'), { message: 'Invalid value: Expected int64 to be <= 9223372036854775807' }).optional(),
    code: z.string(),
 ...
 */
export const zCredentialOption = z.object({
    credential_type: z.enum(['api_key', 'gcp_service_account']),
    input_type: z.enum(['text', 'json_file']),
    label: z.string()
});
...
export const zSecretProvider = z.object({
    credential_options: z.array(zCredentialOption).optional(),
    id: z.string(),
...
export const zPreviewSubscribeResponse = z.object({
    allowed: z.boolean(),
    amount_due_cents: z.coerce.bigint().min(BigInt('-9223372036854775808'), { message: 'Invalid value: Expected int64 to be >= -9223372036854775808' }).max(BigInt('9223372036854775807'), { message: 'Invalid value: Expected int64 to be <= 9223372036854775807' }).optional(),
    ...
    renewal_amount_cents: z.coerce.bigint().min(BigInt('-9223372036854775808'), { message: 'Invalid value: Expected int64 to be >= -9223372036854775808' }).max(BigInt('9223372036854775807'), { message: 'Invalid value: Expected int64 to be <= 9223372036854775807' }).optional(),
...
export const zCreateSecretRequest = z.object({
    credential_type: z.enum(['api_key', 'gcp_service_account']).optional().default('api_key'),
...
export const zBillingCapabilitiesResponse = z.object({
    ...
    revision: z.coerce.bigint().min(BigInt('-9223372036854775808'), { message: 'Invalid value: Expected int64 to be >= -9223372036854775808' }).lte(BigInt(9007199254740991)),
...
export const zAgentSkillPublishRequest = z.object({
    ...
    name: z.string().max(64).regex(/^[A-Za-z0-9._-]*[A-Za-z0-9_-][A-Za-z0-9._-]*$/)
});
...
export const zUpdateBillingCompanyDetailsBody = zBillingCompanyDetailsUpdateRequest;

/**
 * Success
 */
export const zUpdateBillingCompanyDetailsResponse = zBillingCompanyDetailsResponse;
...
export const zListJobsQuery = z.object({
    ...
    sort_by: z.enum(['create_time', 'execution_time']).optional().default('create_time'),
