...
| How does implementation align with ADR-CLMC and ADR-ECS?          | [Decision traceability](ecs-decision-traceability.md)                 |
...
[ADR-CLMC](../../adr/CLMC-crdt-based-layout-system.md) governs centralized
