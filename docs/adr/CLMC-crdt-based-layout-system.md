# ADR-CLMC: Centralized Layout Management with CRDT
...
This decision builds on [ADR-MLCF (Merge LiteGraph)](MLCF-merge-litegraph-into-frontend.md), which enables the architectural restructuring proposed here.
